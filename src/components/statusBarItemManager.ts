...
export class StatusBarItemManager {
    ...
    moveToBootstrap() {
        ...
        this.#statusBarItem.tooltip = 'Bootstrapping the Nora Node Engine and the Nora Rust Engine';
        this.#statusBarItem.show();
    }
    ...
    moveToProgress(
        ...
        const percentage = Math.trunc((100 * numberOfProcessedFiles) / numberOfTotalFiles);
